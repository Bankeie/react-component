...
const App = () => {
  const beverageList = [
    ...
    description: "Warm and comforting hot chocolate, made with real Belgi chocolate.",
    price: "$3.00"
    },
    {
    image: "orange-coconut.jpg",
    name: "Orange Coconut Delight",
    description: "Tropical blend of orange and coconut milk, perfect for a summ day.",
    price: "$4.50"
    },
    {
